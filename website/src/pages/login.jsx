...
class Login extends Component {
  ...
  render() {
    ...
    return (
      <div className="login">
        <img src={efacImg} className="loginImg" alt=""></img>
        <img src={PeraLogo} className="logo" alt=""></img>
        ...
        <div className="lgnloginCard">
          <LoginCard
            ...
            ocn={this.nameChangeHandler}
            ocp={this.passChangeHandler}
            sr={this.sendReq}
