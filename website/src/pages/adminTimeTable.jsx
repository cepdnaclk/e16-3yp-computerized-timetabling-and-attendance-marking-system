...
class TimeTable extends Component {
  ...
  submitSchedules = () => {
    ...
    const auth = "Bearer " + localStorage.getItem("token");
    axios
      .post(SUBMIT_ALL_SCHEDULES_URL, data, {
        headers: {
          Authorization: auth,
        },
      })
  ...
  displayPopOver = () => {
    if (this.state.workDone === true) {
      return (
        <PopOver info="TimeTable sucsesfully updated — Refresh the page!"></PopOver>
      );
    }
  };
        ...
        <div>
          ...
          <div className="tt-align-outer">
            ...
            <div className="tt-submitschedules">
              ...
              ></SubmitSchedules>
              <div className="tt-popOver">{this.displayPopOver()}</div>
            </div>
          </div>
        </div>
        <Footer />
