...
//            System.out.println("Notification id  :"+ notification.getNotificationId());
    ...
    public String setStatus(String id) {
        return notificationDAO.setStatus(id);
    }
    ...
    public Collection<Notification> findAllByDayOfWeekAndTime() {
        ...
        System.out.println("current from service = "+str_current);

        return notificationDAO.findAllByDayOfWeekAndTime(dayOfWeek,str_current);
    }
}
