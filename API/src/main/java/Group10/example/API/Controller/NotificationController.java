...
public class NotificationController {
    ...
    @GetMapping(value = "/findbydayandtime/all")
    public Collection<Notification> findAllByDayOfWeekAndTime(){
        return notificationService.findAllByDayOfWeekAndTime();
    }
    ...
    public String setStatus(@PathVariable("id")String id){
        return notificationService.setStatus(id);
    }
}
